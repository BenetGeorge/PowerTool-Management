...
================================================== -->
  <!-- Bootstrap -->
  <link rel="stylesheet" href="Assets/Templates/Main/plugins/bootstrap/bootstrap.min.css">
  <!-- FontAwesome -->
  <link rel="stylesheet" href="Assets/Templates/Main/plugins/fontawesome/css/all.min.css">
  <!-- Animation -->
  <link rel="stylesheet" href="Assets/Templates/Main/plugins/animate-css/animate.css">
  <!-- slick Carousel -->
  <link rel="stylesheet" href="Assets/Templates/Main/plugins/slick/slick.css">
  <link rel="stylesheet" href="Assets/Templates/Main/plugins/slick/slick-theme.css">
  <!-- Colorbox -->
  <link rel="stylesheet" href="Assets/Templates/Main/plugins/colorbox/colorbox.css">
  <!-- Template styles-->
          ...
          <div class="row">
              <div class="col-lg-8 col-md-8">
                <ul class="top-info text-center text-md-left">
                    <li><i class="fas fa-map-marker-alt"></i> <p class="info-text">Kerala ,India</p>
                    </li>
                </ul>
              </div>
              <!--/ Top info end -->
                  ...
                  <li>
                    <div class="info-box">
                      <div class="info-box-content">
                          ...
                          <p class="info-box-subtitle">9946257152</p>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="info-box">
                      <div class="info-box-content">
                          ...
                          <p class="info-box-subtitle">powertools@gmail.com</p>
                      </div>
                    </div>
                  </li>
                  <li class="last">
                ...
                <div id="navbar-collapse" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav mr-auto">
                     <!-- <li class="nav-item dropdown active">
                          <a href="/miniproject/project/Guest/Login.php" class="active " >Login </a> -->
                      ...
                      <li class="nav-item"><a class="nav-link" href="\miniproject\project\User\Complaint.php">Feedback</a></li>
                    </ul>
                </div>
              </nav>
          </div>
...
<div class="banner-carousel banner-carousel-1 mb-0">
  <div class="banner-carousel-item" style="background-image:url(Assets/Templates/Main/images/slider-main/Equipments4.jpg)">
    <div class="slider-content">
        <div class="container h-100">
          <div class="row align-items-center h-100">
              <div class="col-md-12 text-center">
                <h2 class="slide-title" data-animation-in="slideInLeft">Leading the way in</h2>
                <h3 class="slide-sub-title" data-animation-in="slideInRight">Power Tool Rentals</h3>
  ...
  <div class="banner-carousel-item" style="background-image:url(Assets/Templates/Main/images/slider-main/Equipment5.jpg)">
    <div class="slider-content text-left">
        <div class="container h-100">
          <div class="row align-items-center h-100">
              <div class="col-md-12">
                <h2 class="slide-title-box" data-animation-in="slideInDown">World Class Equipments</h2>
  ...
  <div class="banner-carousel-item" style="background-image:url(Assets/Templates/Main/images/slider-main/Equipment6.jpg)">
    <div class="slider-content text-right">
        <div class="container h-100">
          <div class="row align-items-center h-100">
              <div class="col-md-12">
                <h2 class="slide-title" data-animation-in="slideInDown">Power up</h2>
                <h3 class="slide-sub-title" data-animation-in="fadeIn">your projects with</h3>
                <p class="slider-description lead" data-animation-in="slideInRight">the right gear today.</p>
        ...
        <div class="row align-items-center">
          ...
          <!--<div class="col-md-4 text-center text-md-right mt-3 mt-md-0">
              <div class="call-to-action-btn">
                <a class="btn btn-dark" href="/miniproject/project/Guest/Login.php">LOGIN</a>
              </div>-->
          </div><!-- col end -->
        </div><!-- row end -->
    ...
    <div class="row">
        <div class="col-lg-6">
          <div class="ts-intro">
              ...
              <h3 class="into-sub-title">We deliver Quality Equipments
              </h3>
...
<!--/ News end -->
  ...
  <script src="Assets/Templates/Main/plugins/jQuery/jquery.min.js"></script>
  <!-- Bootstrap jQuery -->
  <script src="Assets/Templates/Main/plugins/bootstrap/bootstrap.min.js" defer></script>
  <!-- Slick Carousel -->
  <script src="Assets/Templates/Main/plugins/slick/slick.min.js"></script>
  <script src="Assets/Templates/Main/plugins/slick/slick-animation.min.js"></script>
  <!-- Color box -->
  <script src="Assets/Templates/Main/plugins/colorbox/jquery.colorbox.js"></script>
  <!-- shuffle -->
  <script src="Assets/Templates/Main/plugins/shuffle/shuffle.min.js" defer></script>


  <!-- Google Map API Key-->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU" defer></script>
  <!-- Google Map Plugin-->
  <script src="Assets/Templates/Main/plugins/google-map/map.js" defer></script>
